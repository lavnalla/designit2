      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-[1120px] flex-col overflow-hidden bg-[#dff6e8] shadow-[0_28px_80px_rgba(15,23,42,0.12)]">
        <main className="flex-1 px-5 py-12 md:px-8 md:py-14">
          <div className="mx-auto max-w-5xl">
            <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#8a644a]">About DesignIt</p>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12 mt-12 border-t border-[#ead8dc] pt-10">
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="border border-[#ead8dc] bg-[#fffaf8] p-6 shadow-[0_18px_36px_rgba(15,23,42,0.06)]">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="font-black text-2xl text-[#8f6a88]">✓</span>
                  <div>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                ...
                <Link href="/contact" className="font-bold text-[#8f6a88] underline transition-colors hover:text-[#4f264f]">
                  contact page
                </Link>{" "}
                to get in touch.
              </p>
          ...
          <div className="mt-16 border-t border-[#ead8dc] pt-10 text-center">
